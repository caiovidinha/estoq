...
>
  ...
  <ul className="mt-5 space-y-4 px-4">
    ...
    <li onClick={() => { setMenuOpen(false); router.push('/pagamentos'); }}>
      <div className={router.pathname === "/pagamentos" ? activeClass + " flex flex-row items-center justify-center gap-3" : inactiveClass + " flex flex-row items-center justify-center gap-3"}>
      ...
      <nav className="hidden sm:grid grid-cols-6 gap-8 px-4 pt-4 bg-gray-100">
        ...
        <Link href="/pagamentos">
          <div className={router.pathname === "/pagamentos" ? activeClass + " flex flex-row items-center justify-center gap-3" : inactiveClass + " flex flex-row items-center justify-center gap-3"}>
            <MdOutlinePayments size={25} />
            <p className="hidden sm:block font-bold">Pagamentos</p>
          </div>
        </Link>
      </nav>
