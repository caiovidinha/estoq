    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2 mb-3 items-center justify-between">
          ...
          <select
            id="ano"
            className="flex-1 bg-blue-800 px-2 py-2 rounded-lg text-blue-200 font-semibold border border-blue-700 hover:bg-blue-700"
            style={{ fontSize: '16px' }}
          ...
          <select
            id="mes"
            className="flex-1 bg-blue-200 px-2 py-2 rounded-lg text-blue-800 font-semibold border border-blue-300 hover:bg-blue-300"
            style={{ fontSize: '16px' }}
