...
const Apagar = () => {
    ...
    // Removemos os endpoints do Zapier
    ...
    // Função de exclusão atualizada para chamar o endpoint interno
    ...
    // Função de atualização de status atualizada para chamar /api/updateStatus
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
                        ...
                        {movimentacao.slice(0).map((mov, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {mov.descritivo === 'Alimentação' ? (
                                            <BiRestaurant size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Locomoção' ? (
                                            <BiCar size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Academia' ? (
                                            <GiWeightLiftingUp size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Celular' ? (
                                            <BiPhone size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Vestuário' ? (
                                            <BiSolidTShirt size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Cartão' ? (
                                            <BiCreditCardAlt size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Dívida' ? (
                                            <BiBomb size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Lazer' ? (
                                            <BiSmile size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Saúde' ? (
                                            <GiHealthNormal size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Bet' ? (
                                            <SiBetfair size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Presente' ? (
                                            <BiGift size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Serviços' ? (
                                            <AiOutlineTool size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Investimento' ? (
                                            <RiFundsBoxLine
                                                size={20}
                                                className={
                                                    mov.tipo === 'RECEITA'
                                            ...
                                            <RiBillLine size={20} className="text-red-800" />
                                        ) : mov.descritivo === 'Salário - V4' ? (
                                            <BiMoneyWithdraw size={20} className="text-green-800" />
                                        ) : mov.descritivo === 'Freelance' ? (
                                            <SiFreelancer size={20} className="text-green-800" />
                                        ) : mov.descritivo === 'Limite Cartão' ? (
                                            <BiCreditCardAlt size={20} className="text-green-800" />
                                        ) : mov.descritivo === 'Reembolso' ? (
                                            <MdMoneyOff size={20} className="text-green-800" />
                                        ) : mov.descritivo === 'Viagem' ? (
                                            <SiYourtraveldottv size={20} className="text-red-800" />
                                        ) : (
                                            <BsThreeDots
                                                size={20}
                                                className={
            ...
            <div>
                ...
                <Modal closeButton aria-labelledby="modal-title" open={confirmarExc} onClose={closeConf}>
                    <Modal.Header>
                        <Text id="modal-title" size={18}>
                            <Text b size={18}>
                        ...
                        <div className="text-center bg-gray-100 rounded-lg -my-1 p-3 grid">
                            <Text>
                                {excluido
                                    ...
                                    : loading
                                        ? 'Por favor, aguarde...'
                                        : 'Deseja excluir a movimentação do histórico? Isso irá afetar todos valores que utilizavam essa informação!'}
                            </Text>
                        </div>
                    </Modal.Body>
                    <Modal.Footer>
