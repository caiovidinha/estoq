            ...
            <div className="p-4">
                <div className="w-full m-auto p-4 border rounded-lg overflow-y-auto">
                    <div className='w-full flex md:justify-end h-10 '>
                        ...
                        <div className="w-full items-end md:justify-end justify-around flex my-2 p-3 bg-gray-200 rounded-lg"><p className='font-bold'>A receber:&nbsp;</p>R${receber ? receber.toString().replace('.',',') : '0,00'}&nbsp;|&nbsp;<p className='font-bold'>A pagar:&nbsp;</p>R${pagar ? (-pagar).toString().replace('.',','): '0,00'}</div>
